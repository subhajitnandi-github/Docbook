import { SIGN_IN, SIGN_OUT, CREATE_STREAM, FETCH_STREAM, EDIT_STREAM, DELETE_STREAM, FETCH_STREAMS } from './types';
...
export const createStream = (formValues) => {
	return async (dispatch) => {
		const response = await streamyApi.post('/streams/new', formValues);
		dispatch({
			type: CREATE_STREAM,
